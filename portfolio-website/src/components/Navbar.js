...
import photo from "../landingPagePic.png";
                        ...
                        <div className="collapse navbar-collapse " id="navbarSupportedContent">
                            <ul className="navbar-nav  mb-2 mb-lg-0 navbar-ul-custom">
                                <li className="nav-item">
                                    <a className="nav-link active" aria-current="page" href="/">Home<span className='fullstop'>.</span></a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href="/">About Me<span className='fullstop'>.</span></a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href="/">Project<span className='fullstop'>.</span></a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" href="/">Contacts<span className='fullstop'>.</span></a>
                                </li>
